    ...
    return (<div>
        <div className='Nav hero is-small is-success'>
          <div className='hero-body'>
            ...
            <ShoppingList />
          {(this.props.budget - this.props.totalSpend) < 0 && <Alert noBudget={this.props.budget == 0} />} 
          </div>
          ...
          <div className='completed'>
            <button className='button is-normal is-warning has-text-white' onClick={() => this.done()}>
              {this.props.budget - this.props.totalSpend > 0.01 ? <Link className='nav-item' to='/celebration'>Done</Link> : 
